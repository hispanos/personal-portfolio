...
const App = () => {
    let title = 'About Me',
        description = 'I am a web developer passionate about technology, I like to deliver jobs on time, and I try to make your dreams come true.';
        ...
        <div className="active-dark bg_color--9">
                                ...
                                <div className="row">
                                    <div className="col-lg-12">
                                        <div className={`inner ${value.textPosition}`}>
                                            ...
                                            <h1 className="title">I’m Mailer Martínez <br/>
                                            <TextLoop>
                                                <span> Web Developer.</span>
                                                <span> UI/UX Designer.</span>
                                                <span> JS - React Developer.</span>
                                                <span> PHP - Developer.</span>
                                            </TextLoop>{" "}
                                            </h1>
                                            <h2>with love from Colombia.</h2>
            ...
            <div id="contact" className="fix">
                <div className="rn-contact-area pb--120 bg_color--8">
                    <Contact contactImages="/assets/images/about/about-13.jpg" contactTitle="Hire Me." />
                </div>
            </div>
            {/* End COntact Area */}
